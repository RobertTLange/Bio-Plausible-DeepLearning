...
%------------------------------------------------------------------------------%
\begin{frame}{Summary ... and where to go?}

\begin{todolist}
	\item[\done] Electrical segregation $\Rightarrow$ Near-continuous time
	\item[\wontfix] \textbf{Computational} and \textbf{Physiological} Problems
\end{todolist}
	\pause
