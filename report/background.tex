...
\missingfigure{Table of hyperparameters search space for different models}

\fcolorbox{black}[HTML]{E9F0E9}{\parbox{\textwidth}{%
\noindent \textbf{MLP Hyperparameter Search Space:}
\small{
\begin{enumerate}
	\item Layer 1
\end{enumerate}}}}
...
\fcolorbox{black}[HTML]{E9F0E9}{\parbox{\textwidth}{%
\noindent \textbf{CNN Hyperparameter Search Space:}
\small{
\begin{enumerate}
	\item Layer 1
\end{enumerate}}}}
...
\fcolorbox{black}[HTML]{E9F0E9}{\parbox{\textwidth}{%
\noindent \textbf{\citet{guerguiev2017} Hyperparameter Search Space:}
\small{
\begin{enumerate}
	\item Layer 1
\end{enumerate}}}}
